        ...
        <div class="container">
            <div class="install-content">
                <div class="step-header">
                    <div class="step"
                         :class="{ active: step.number === steps.current, success: steps.success, error: !steps.success }"
                            ...
                            <div class="col-12">
                                <scrollbar class="scrollbar-wrap">
                                    <div class="scrollbar-content">
                                        ...
                                        <p>
                                            您可一获得该许可的副本，在http://www.apache.org/licenses/LICENSE-2.0除非适用法律需要或者书面同意，按本许可分发的软件要按“原样”分发，没有任何形式的，明确或隐含的担保条款。参见按照本许可控制许可权限及限制的特定语言的许可证。</p>
                                    </div>
                                </scrollbar>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group" :class="{ error: errors.has('sitename') }">
                                    <label>您的网站名称</label>
                                    <input type="text" name="sitename" placeholder="请输入网站名称" v-model="sitename"
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <label :class="{ active: database.engine === 'sqlite' }">
                                            <input type="radio" name="database" value="sqlite"
                                                   v-model="database.engine">SQLite3
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row" v-if="database.engine !== 'sqlite'">
                            ...
                            <div class="col-4">
                                <div class="form-group" :class="{ error: errors.has('database') }">
                                    <label>数据库名称</label>
                                    <input type="text" name="database" placeholder="请输入数据库名称"
                                           v-model="database.database" v-validate="validates.database.database">
                                </div>
                            </div>
                        </div>
                        <div class="row" v-if="database.engine !== 'sqlite'">
                            <div class="col-4">
                                <div class="form-group" :class="{ error: errors.has('database_username') }">
                                    <label>数据库用户名</label>
                                    <input type="text" name="database_username" placeholder="请输入数据库用户名"
                    ...
                    <div class="form-horizontal">
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group" :class="{ error: errors.has('sitename') }">
                                    <label>管理员邮箱</label>
                                    <input type="text" name="mail" placeholder="请输入管理员邮箱" v-model="account.mail"
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group" :class="{ error: errors.has('username') }">
                                    <label>管理员账号</label>
                                    <input type="text" name="username" placeholder="请输入管理员账号" v-model="account.username"
                            ...
                            <div class="col-4">
                                <div class="form-group" :class="{ error: errors.has('password') }">
                                    <label>管理员密码</label>
                                    <input type="text" name="password" placeholder="请输入管理员密码" v-model="account.password"
